package com.iconicsbooking.exception;
...
import com.iconicsbooking.model.ApiErrors;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleCompanyNotFound(CompanyNotFoundException ex) {

		String message= ex.getMessage();
		LocalDateTime timestamp= LocalDateTime.now();
		String error="Exception is caused in company microservice";
	...
	protected ResponseEntity<Object> handleEventsNotFoundException(EventsNotFoundException ex) {

		String message= ex.getMessage();
		LocalDateTime timestamp= LocalDateTime.now();
		String error="Exception is caused in events microservice";
		ApiErrors errors= new ApiErrors(timestamp, message, HttpStatus.CONFLICT.value(), error);
